...
//        gp.currentMap = 3;
        ...
        mana = maxMana;
        ammo = 10;
        strength = 1000;       // The more strength he has, the more damage he gives.
    ...
    public void update() // Runs 60 times every seconds.
    {
        ...
        } else if (attacking) //Need to adjust attack to "up" and "left" cuz player goes back a tile. Need to adjust drawing start point(x,y)
        {
            attacking();
            ...
            if (keyH.upPressed) {
                direction = "up";
            } else if (keyH.downPressed) {                                                                 // You can go up and down while you pressing left or right.
                direction = "down";                                           // But if you going up or down you cannot press left or right
            }                                                                 // The reason is here the if statements order.
            else if (keyH.leftPressed)                                 // For example when "keyH.upPressed == true", the else if blocks are not working. And you cannot go anyway when you press up.
            {
                direction = "left";
        ...
        //PROJECTILE SHOOTING
        if (gp.keyH.shotKeyPressed && !projectile.alive && shotAvailableCounter == 30 && projectile.haveResource(this))   //2nd Condition : You can shoot it only one at a time
